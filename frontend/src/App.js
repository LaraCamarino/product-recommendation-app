...
function App() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center py-10">
      <div className="bg-white p-8 rounded-3xl shadow-md w-full md:w-3/4 lg:w-1/2 gap-8">
        <div className="mb-5">
          <h1 className="text-center text-4xl font-bold mb-8 text-[#003d5c]">Recomendador de Produtos RD Station</h1>
          <p className="text-justify text-lg ">
            ...
            <br/> Use o formulário abaixo para selecionar suas preferências e funcionalidades desejadas e receba recomendações personalizadas de produtos que melhor atendam às suas necessidades.
          </p>
        </div>
